...
def read_and_download_from_file3(file_path, save_directory):
    with open(file_path, 'r') as file:
        # Đọc từng dòng trong tệp văn bản
    ...
    for item in json_data:
        # Kiểm tra xem khóa "emojiUnicode" có tồn tại trong mỗi mục không
        if "emojiUnicode" in item:
            # In ra giá trị của khóa "emojiUnicode"
            name = item["emojiUnicode"]
            myUrl = "https://ilyassesalama.github.io/EmojiMixer/emojis/supported_emojis_png/" + name +".png"
            download_and_save(myUrl, save_directory)
            print(myUrl)


def read_and_download_from_file4(file_path, save_directory):
    json_data = [
        "1fa84",
        "1f600",
        "1f603",
    ...
    # Sử dụng ThreadPoolExecutor để tải xuống đồng thời
    for item in json_data:
        myUrl = "https://raw.githubusercontent.com/googlefonts/noto-emoji/main/svg/emoji_u" + item + ".svg"
        download_and_save(myUrl, save_directory)
        print(myUrl)
...
read_and_download_from_file4("E:\EmojiResource/responseAllIconSimple.json","E:\EmojiDownloaded3")
